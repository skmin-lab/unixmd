...
qm = qm.dftbplus.SSR(molecule=mol, scc_max_iter=10000, ocdftb=True, \
    periodic=False, do_charge="electrostatic", nthreads=1, \
...
mm = mm.Tinker(molecule=mol, scheme="additive", periodic=False, \
    ...
    do_charge="electrostatic", do_vdw=None, mm_path="/home/islee/program/tinker/bin/", nthreads=1, version=8.7)

md = mqc.SH(molecule=mol, nsteps=800, dt=0.125, istate=1, propagation="density")
