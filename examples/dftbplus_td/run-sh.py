...
md = mqc.SH(molecule=mol, nsteps=400, dt=0.125, istate=2, propagation="density")

bathT = rescale1(temperature=300.0, nrescale=20)

md.run(molecule=mol, theory=qm, thermostat=bathT, input_dir="./TRAJ-sh", save_scr=True, save_QMlog=False, debug=0)
