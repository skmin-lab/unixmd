...
mol = Molecule(geometry=geom, nstates=3, charge=0., unit_pos="au")

qm = qm.dftbplus.DFTB(molecule=mol, scc_tol=1E-6, scc_max_iter=200, \
    ocdftb=False, lcdftb=False, lc_method="MatrixBased", \
    sk_path="/home/vhagemann/SK-files/", sdftb=True, unpaired_elec=1, elec_temp=0.0,\
...
md.run(molecule=mol, qm=qm, thermostat=bathT, input_dir="./TRAJ.cnh4.spin", debug=0)
