...
qm = qm.terachem.SSR(molecule=mol, functional="wPBEh", basis_set="6-31gs", precision="dynamic", \
    ssr22=True, guess="dft", reks_rho_tol=1E-6, reks_max_iter=10000, shift=0.3, \
    use_ssr_state=True, cpreks_grad_tol=1E-6, cpreks_max_iter=1000, \
    qm_path="/opt/TeraChem/bin/", ngpus=2, gpu_id="0 1", version=1.93)
